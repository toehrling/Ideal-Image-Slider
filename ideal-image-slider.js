...
var IdealImageSlider = function() {
    ...
    var _touch = {
        ...
        transitionEnd: function(event) {
            if (_touch.vars.direction) {
                ...
                var slides = this._attributes.slides, index = slides.indexOf(this._attributes.currentSlide);
                if (_touch.vars.direction == "next") {
   ...
   */
    var Slider = function(args) {
        ...
        // Slides
        var origChildren = _toArray(sliderEl.children), validSlides = [];
        Array.prototype.forEach.call(origChildren, function(slide, i) {
            if (slide instanceof HTMLImageElement || slide instanceof HTMLAnchorElement) {
                var slideEl = document.createElement("a"), href = "", target = "";
    ...
    Slider.prototype.gotoSlide = function(index) {
        ...
        var slides = this._attributes.slides, oldIndex = slides.indexOf(this._attributes.currentSlide);
